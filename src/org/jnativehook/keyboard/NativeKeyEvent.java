	...
	public String paramString() {
		...
		switch(getID()) {
			case NATIVE_KEY_PRESSED:
				...
				for(int i : CPressedList.getInstance())
				{
					if(i == rawCode)
					{
						wasPressed = true;
				...
				if(!wasPressed)
				{
					CPressedList.getInstance().add(rawCode);
				}
				
				param.append(',');
				param.append("myCode=");
				param.append(CPressedList.getInstance().indexOf(new Integer(rawCode)));
...
*/
		...
		switch (keyChar) {
			...
			default:
				...
				{
					param.append("LOWERCASE_CHARACTER");
				}
				else if(keyChar >= 'A' && keyChar <= 'Z')
				{
					param.append("UPERCASE_CHARACTER");
				}
